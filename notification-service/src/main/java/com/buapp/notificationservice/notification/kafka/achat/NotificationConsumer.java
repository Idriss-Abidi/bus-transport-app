...
import com.buapp.notificationservice.notification.achatnotification.Notification;
import com.buapp.notificationservice.notification.achatnotification.NotificationService;
...
public class NotificationConsumer {
    ...
    @KafkaListener(topics = "ticket", groupId = "notification-service-group", containerFactory = "achatKafkaListenerContainerFactory")
